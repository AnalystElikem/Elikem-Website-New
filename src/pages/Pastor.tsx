...
import pastorImg from "../assets/about/ps_ea1.png";
  ...
  return (
    <div style={{ background: "#f5f2eb", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          {pastorContent.sections.map((section, i) => (
          ...
          <div style={{ marginTop: "50px" }}>
            {pastorContent.signature.map((line, i) => (
              <p
                key={i}
                style={{
                  fontFamily: "Inter, sans-serif",
          ...
          <div style={{ marginTop: "60px", paddingTop: "40px", borderTop: "1px solid #e0dcd2" }}>
            <button
              type="button"
              onClick={() => navigate({ pathname: "/", hash: "expertise-pastor" })}
              style={{
                display: "block",
                width: "100%",
                maxWidth: "420px",
            ...
            >
              ← Back to Pastor on the homepage
            </button>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
